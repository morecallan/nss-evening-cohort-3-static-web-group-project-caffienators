...
staffArray[2] = ["Anjali", "Customer Service", "We lured Anjali from a sweet gig at Amazon by offering her all the Tang she can drink.", "img/staff/Anjali.jpg", "anjali@selp.com"];
...
staffArray[5] = ["Dave", "Shipping", "Dave spends weekends with his daughter playing with the toys he wasted his whole paycheck buying.  No, there's not a staff discount, Dave.", "img/staff/Dave.jpg", "dave@selp.com"];
staffArray[6] = ["Sherri", "Sales Manager", "We often worry about Sherri.", "img/staff/Sherri.jpg", "sherri@selp.com"];
...
var displayStaff = function(myArray) {
  ...
  staff.innerHTML += "<article class='staffCard " + bgColor + "'><a href='mailto:" + currentPerson[4] + "' class='staffName'><h1>" + currentPerson[0] + "</h1></a> <div class='image'><img src='" + currentPerson[3] + "' alt='' class='staffImage'></div><p class='staffTitle'>" + currentPerson[1] + "</p><p class='staffBio'>" + currentPerson[2] + "</p></article>";
}
